...
import 'package:furniture_app/core/functions/api_services.dart'; // Import updated ApiServices
...
class HomeCubit extends Cubit<HomeState> {
  ...
  final String? userId = SupabaseManager().client.auth.currentUser?.id;
